  ...
  We bridge the gap between job seekers and employers, specifically those that might not have the resources to accommodate a different style of work and find his/her deserving job at ease.            </h5>
      ...
      <Content ref={addToRefs}>
        <TextBlock
          ...
          subText={
            <h5>
            JobMitra is a marketplace for recruiters to find the best match for their vacant positions. Create a job post in minutes to tap into a network of professionals. Share that you're hiring to get qualified potential candidates with the skills and experience you need
            </h5>
          }
        />
        <OBJ>
